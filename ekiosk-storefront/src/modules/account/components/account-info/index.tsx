  ...
  return (
    <div className="text-small-regular" data-testid={dataTestid}>
      ...
      <Disclosure>
        <Disclosure.Panel
          static
          className={clx("overflow-hidden transition-[max-height,opacity] duration-300 ease-in-out", {
      ...
      <Disclosure>
        <Disclosure.Panel
          static
          className={clx("overflow-visible transition-[max-height,opacity] duration-300 ease-in-out", {
