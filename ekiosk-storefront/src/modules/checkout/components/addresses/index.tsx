              ...
              <div className="flex items-start gap-x-8">
                <div className="flex w-full items-start gap-x-1">
                  <div className="flex w-1/3 flex-col" data-testid="shipping-address-summary">
                    <Text className="txt-medium-plus mb-1 text-ui-fg-base">Shipping Address</Text>
                  ...
                  <div className="flex w-1/3 flex-col" data-testid="billing-address-summary">
                    <Text className="txt-medium-plus mb-1 text-ui-fg-base">Billing Address</Text>
