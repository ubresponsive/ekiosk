      ...
      <RadioGroup data-testid={dataTestId} onValueChange={handleChange}>
        {items?.map((i) => (
          ...
          >
            ...
            <RadioGroup.Item checked={i.value === value} className="peer hidden" id={i.value} value={i.value} />
            <Label
              htmlFor={i.value}
              className={clx("!txt-compact-small !transform-none text-ui-fg-subtle hover:cursor-pointer", {
